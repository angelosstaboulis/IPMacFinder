        ...
        return await withCheckedContinuation { continuation in
            ...
            AF.request(request).responseData { dataResponse in
                do{
                    ...
                    self.ipINFO.append(self.fillIPModelWithValues(json: json))
